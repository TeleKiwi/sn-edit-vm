...
document.addEventListener("keydown", function onEvent(event) {
    ...
    if (key.length === 1) {
        input+=key
        /*
        input=insert_string(input,inputindex,key)
        inputindex++
        */
...
function insert_string(str, index, insert) {
    ...
    getInfo () {
        return {
            ...
            blocks: [
                ...
                {
                    opcode: 'setuserinputindex',
                    text: formatMessage({
                        id: 'sn.blocks.setinputindex',
                        default: 'Set Input Index to [set]',
                        description: 'Sets the users input index'
                    }),
                    arguments: {
                        set: {
                            type: ArgumentType.NUMBER,
